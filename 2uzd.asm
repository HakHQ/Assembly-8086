; Programa, kuri nuskaito is failo duomenys ir pavercia is 1 -> vienas 2->du ir t.t ir įrašo į kitą failą kurio pavadinimą nurodėt
; tasm programospavadinimas.exe failoPavadinimasIsKurioSkaitys failoPavadinimasIKuriIrasys
